    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_command', models.ForeignKey(db_column='check_command', on_delete=django.db.models.deletion.DO_NOTHING, to='nagios.NagiosChecks')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_options', models.CharField(blank=True, max_length=64, null=True)),
                ('notifications_enabled', models.SmallIntegerField(blank=True, null=True)),
                ('check_command', models.ForeignKey(blank=True, db_column='check_command', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='nagios.NagiosChecks')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
                ('contactgroup', models.ForeignKey(blank=True, db_column='contactgroup', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='nagios.NagiosContactgroups')),
                ('service', models.ForeignKey(blank=True, db_column='service', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='nagios.NagiosServices')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='NagiosContactgroupsMembers',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False)),
                ('contact', models.ForeignKey(blank=True, db_column='contact', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='nagios.NagiosContacts')),
                ('contactgroup', models.ForeignKey(blank=True, db_column='contactgroup', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='nagios.NagiosContactgroups')),
            ],
            options={
